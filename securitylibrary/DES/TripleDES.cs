...
namespace SecurityLibrary.DES
{
    ...
    public class TripleDES : ICryptographicTechnique<string, List<string>>
    {
        public string Decrypt(string cipherText, List<string> key)
        {
            ...
            string finalResult = "";
            finalResult = desDecryptOnce(cipherText, key[0]);
            finalResult = desEncryptOnce(finalResult, key[1]);
            finalResult = desDecryptOnce(finalResult, key[0]);
            return finalResult;
        }
        ...
        public string Encrypt(string plainText, List<string> key)
        {
            //throw new NotImplementedException();
            string finalResult = "";
            finalResult = desEncryptOnce(plainText, key[0]);
            finalResult = desDecryptOnce(finalResult, key[1]);
            finalResult = desEncryptOnce(finalResult, key[0]);
            return finalResult;
        }
        ...
        private string desEncryptOnce(string plainText,string key)
        {
        ...
        private string desDecryptOnce(string cipherText, string key)
        {
